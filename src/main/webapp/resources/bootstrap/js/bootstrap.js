...
+function ($) {
    ...
    if ((version[0] < 2 && version[1] < 9) || (version[0] == 1 && version[1] == 9 && version[2]
                                                                                     < 1)) {
...
+function ($) {
    ...
    function getParent($this) {
        ...
        if (!selector) {
            selector = $this.attr('href')
            selector =
            selector && /#[A-Za-z]/.test(selector) && selector.replace(/.*(?=#[^\s]*$)/, '') // strip
                                                                                             // for
                                                                                             // ie7
        }
    ...
    Tooltip.prototype.show = function () {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            if (autoPlace) {
                ...
                placement =
                placement == 'bottom' && pos.bottom + actualHeight > containerDim.bottom ? 'top' :
...
+function ($) {
    ...
    Popover.prototype.setContent = function () {
        ...
        $tip.find('.popover-content').children().detach().end()[ // we use append for html objects to
            // maintain js events
